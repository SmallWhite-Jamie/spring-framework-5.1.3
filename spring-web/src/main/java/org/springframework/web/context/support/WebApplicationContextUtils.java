...
public abstract class WebApplicationContextUtils {
	...
	public static void registerWebApplicationScopes(ConfigurableListableBeanFactory beanFactory,
		...
		// web环境下有很多特定的声明周期：session、request、globalSession、application、spring在处理时候为各种不同的对象设置特有的web环境
		...
		// 为web环境的特定对象设置工厂bean，用来产生ServletRequest、ServletResponse、HttpSession、WebRequest
