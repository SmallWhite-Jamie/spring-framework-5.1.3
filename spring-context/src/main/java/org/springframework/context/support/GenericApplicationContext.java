 ...
 *
 * <p>
 *  GenericApplicationContext是Spring Context模块中最容易构建 Spring环境的实体类，
 * 涵盖了Spring Context的核心功能，在不需要特殊 定制的场景下可以实现开箱即用。譬如
 * {@link org.springframework.context.annotation.AnnotationConfigApplicationContext}
 * 的构造方法先传入 一个 class 数组，再创建一个可执行的上下文实例来构造一个可运行的 Spring运行环境，使用起来非常简便。
 * 如果想扩展适合自己 业务的轻量级 Spring 容器，使用GenericApplicationContext这个基类则 会非常容易上手。
 * </p>
